...
from utils import PSNR_GPU,SAM_Loss
import numpy as np
...
def initialize_SpeDNet(module, msi, hsi, sf):
    ...
    print('Initialize Spectral Degradation Net Successfully. Epoch:{}\tlr:{:.2e}\tAbsolute Error:{:.2f}'.format(epoch,trainer.state_dict()['param_groups'][0]['lr'],-psnr.detach().cpu().numpy()))
    return module
